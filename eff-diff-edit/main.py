...
def parse_args_and_config():
    ...
    # Default
    parser.add_argument('--config', type=str, default='afhq.yml', help='Path to the config file')
    parser.add_argument('--seed', type=int, default=1234, help='Random seed')
    parser.add_argument('--exp', type=str, default='./runs/lpips_stablesif_afhq', help='Path for saving running related data.')
    ...
    parser.add_argument('--wm_loss_w', type=float, default=0.5)
    ...
    # Loss & Optimization
    parser.add_argument('--clip_loss_w', type=int, default=3.0, help='Weights of CLIP loss')
    parser.add_argument('--l1_loss_w', type=float, default=1.0, help='Weights of L1 loss') #1 normal, 3 attack
    ...
    parser.add_argument('--model_path', type=str, default='pretrained/afhqdog_p2.pt', help='Test model path') #celeba_hq.ckpt, afhqdog_p2.pt
