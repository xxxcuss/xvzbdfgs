...
def parse_args_and_config():
    ...
    parser.add_argument('--wm_loss_w', type=float, default=0.5)# 3.0 hid, 0.5 sig
    ...
    # Default
    parser.add_argument('--config', type=str, default='custom_sig_afhq.yml', help='Path to the config file:celeba.yml, custom_sig_celeba.yml')
    parser.add_argument('--seed', type=int, default=1234, help='Random seed')
    parser.add_argument('--exp', type=str, default='./runs/lpips_stablesig_afhq', help='Path for saving running related data.')
    ...
    parser.add_argument('--model_path', type=str, default='pretrained/afhqdog_p2.pt', help='Test model path')


    # Loss & Optimization
    parser.add_argument('--clip_loss_w', type=float, default=1.0, help='Weights of CLIP loss') #1.0
    #parser.add_argument('--clr_loss_w', type=int, default=3, help='Weights of CLIP loss')
    parser.add_argument('--l1_loss_w', type=float, default=3.0, help='Weights of L1 loss') #3.0
    ...
    parser.add_argument('--add_noise_from_xt', default=True, help='add_noise_from_xt')
    parser.add_argument('--origin_process_addnoise', action='store_true', help='origin_process_addnoise')

    # Training Mode
    parser.add_argument('--run_train', default=True, help='run_train')
    parser.add_argument('--train_delta_block', default=True, help='train Delta_block')
    parser.add_argument('--train_delta_h', default=False, help='train Delta_h') ###
    ...
    parser.add_argument('--just_precompute', default=False, help='just_precompute')
    ...
    # Training details
    parser.add_argument('--lr_training', type=float, default=0.5, help='Initial learning rate for training')
    parser.add_argument('--use_x0_tensor', default=True, help='use_x0_tensor')
    parser.add_argument('--save_x0', default=False, help='save x0_tensor (original image)') ###
    ...
    # Sampling
    parser.add_argument('--t_0', type=int, default=999, help='Return step in [0, 1000)')#999
    parser.add_argument('--n_inv_step', type=int, default=50, help='# of steps during generative pross for inversion')#50
    parser.add_argument('--n_train_step', type=int, default=50, help='# of steps during generative pross for train')#50
    parser.add_argument('--n_test_step', type=int, default=50, help='# of steps during generative pross for test')#50
    ...
    parser.add_argument('--LPIPS_addnoise_th', type=float, default=1.2, help='LPIPS_addnoise_th')
    ...
    parser.add_argument('--n_test_img', type=int, default=32, help='# of test images')
    ...
    parser.add_argument('--get_h_num', type=int, default=1, help='Training batch size during Latent CLR')
