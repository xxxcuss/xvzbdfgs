DATASET_PATHS = {
	'FFHQ': 'data/celeba_hq/',
	'CelebA_HQ': '/sda2/diffusion_data/celeba_hq/', #'/sda2/diffusion_data'
	'AFHQ': '/sda2/diffusion_data/afhq',
	'LSUN':  '/sda2/diffusion_data/lsun',
    'IMAGENET': '/sda2/diffusion_data/imagenet/',
}
