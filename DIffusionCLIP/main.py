...
def parse_args_and_config():
    ...
    # Default
    parser.add_argument('--config', type=str, default='afhq.yml', help='Path to the config file: celeba, afhq, bedroom, chu')
    parser.add_argument('--seed', type=int, default=1234, help='Random seed') #1234
    ...
    parser.add_argument('--save_train_image', type=int, default=0, help='Wheter to save training results during CLIP fineuning, default:1')
    ...
    parser.add_argument('--n_train_img', type=int, default=100, help='# of training images') #100
    parser.add_argument('--n_test_img', type=int, default=10, help='# of test images')
    parser.add_argument('--model_path', type=str, default='pretrained/afhqdog_p2.pt', help='Test model path') #celeba_hq.ckpt
    ###afhqdog_p2.pt, celeba_hq.ckpt, bedroom.ckpt, church.ckpt
    parser.add_argument('--img_path', type=str, default='imgs/celeb1.png', help='Image path to test')
    ...
    parser.add_argument('--clip_finetune_eff', type=bool, default=False)
